...
:: See all informartion https://exiftool.org/TagNames/PDF.html
:: command : P                  Preserve file modification date/time
:: command : overwrite_original Overwrite original by renaming tmp file
:: command : m                  Ignore minor errors and warnings
set OPTIONS-EXIFTOOL=-P -overwrite_original -m ^
-Author="" ^
-Creator="CONV_CBx-TO-PDF.BAT" ^
-Producer="Copyright (c) 2022-2026 Fremy&Cie" ^
-Keywords="Convert,Decompress,Create,Compress,Test,Tools,7zip,ImageMagick,NConvert,Ghostscript,ExifTool" ^
-Version="1.5" ^
-ContactInfo="fremyetcie@gmail.com" ^
-Location="https://github.com/FremyEtCie/DOS_Scripts/tree/main/ComicBook-batch-converter"
