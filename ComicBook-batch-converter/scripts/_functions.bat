...
REM -------------------------------------------------
REM --- Met à jour les Tags du fichier PDF genere ---
REM -------------------------------------------------
:ProcedureUpdatePdfTags
::echo #ProcedureUpdatePdfTags# The value of parameter 2 is %2.
echo [INFO] Update PDF files Tags from all files generated >> %BAKCLOG_FILE%
%EXIFTOOL% %OPTIONS-EXIFTOOL% "%~2"
goto :EndFunctions

REM -------------------------------------------------------------------
REM --- Deplacement des fichiers doublons dans le répertoire erreur ---
REM -------------------------------------------------------------------
